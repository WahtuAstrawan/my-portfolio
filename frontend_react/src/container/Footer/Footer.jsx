...
const Footer = () => {
  ...
  return (
    <>
      <h2 className='head-text'>Contact Me Further</h2>
      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          <img src={images.email} alt="email" />
          <a href='mailto:wahtuastrawan08@gmail.com' className='p-text'>wahtuastrawan08@gmail.com</a>
        </div>
        <div className='app__footer-card'>
          <img src={images.mobile} alt="mobile" />
          <a href='tel: +62 (082) 147-074-298' className='p-text'>+62 (082) 147-074-298</a>
        </div>
      </div>
